...
def count_letters(full_name):
    ...
    letter_counts = {}
    for letters in name:
        if letters not in letter_counts:
...
def count_letters_no_spaces(full_name):
    ...
    return count_letters(full_name)
...
def count_letters_no_spaces_punctuation(full_name):
    ...
    full_name = full_name.replace("-", "")
    full_name = full_name.replace("'", "")
    return count_letters_no_spaces(full_name)
...
def count_letters_no_spaces_punctuation_case_sensitivity(full_name):
    ...
    # your code here
    balloon = full_name.lower()
    return count_letters_no_spaces_punctuation(balloon)
